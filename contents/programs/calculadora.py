...
def menu():
    ...
    print("Otro tipo de operaciones")
    print("11- Conversión de decimal a binario \n 12- Convertir de binario a decimal")
    print("13- Convertir de decimal a hexadecimal \n 14- Convertir de decimal a Octal")
    print("15- ")
    print()
    print("0 -  SALIR. ")
    print()
